...
namespace CreateProjectDDDUoW._0___Core
{
    public static class SQLTools
    {
        ...
        public static string GetClass(string connectionString, string tableName)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand(getclass, connection))
                {
        ...
        public static Dictionary<string, string> GetClasses(List<string> tabelas, string connectionString)
        {
            Dictionary<string, string> classes = new Dictionary<string, string>();

            foreach (var table in tabelas)
            {
                classes.Add(table, GetClass(connectionString, table));
            }
    ...
    //        {
    //            string tsql = $"SELECT TOP 1 * FROM {TableName}";
    //            DataTable table = Query.QueryToDataTable(ConnectionString, tsql);
    ...
    //        /// </summary>
    //        /// <param name="ConnectionString">The SQL connection string.</param>
    //        /// <param name="Query">A SQL command that will be passed to string.Format().</param>
    //        /// <param name="FormatString_Parameters">The parameters for string.Format().</param>
